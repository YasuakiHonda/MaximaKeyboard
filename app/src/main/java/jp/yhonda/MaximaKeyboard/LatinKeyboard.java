    ...
    void setImeOptions(Resources res, int options) {
        ...
        switch (options&(EditorInfo.IME_MASK_ACTION|EditorInfo.IME_FLAG_NO_ENTER_ACTION)) {
            case EditorInfo.IME_ACTION_GO:
                ...
                mEnterKey.icon = null;
                mEnterKey.label = res.getText(jp.yhonda.MaximaKeyboard.R.string.label_go_key);
                break;
            case EditorInfo.IME_ACTION_NEXT:
                mEnterKey.iconPreview = null;
                mEnterKey.icon = null;
                mEnterKey.label = res.getText(jp.yhonda.MaximaKeyboard.R.string.label_next_key);
                break;
            case EditorInfo.IME_ACTION_SEARCH:
                mEnterKey.icon = res.getDrawable(jp.yhonda.MaximaKeyboard.R.drawable.sym_keyboard_search);
                mEnterKey.label = null;
                break;
            case EditorInfo.IME_ACTION_SEND:
                mEnterKey.iconPreview = null;
                mEnterKey.icon = null;
                mEnterKey.label = res.getText(jp.yhonda.MaximaKeyboard.R.string.label_send_key);
                break;
            default:
                mEnterKey.icon = res.getDrawable(jp.yhonda.MaximaKeyboard.R.drawable.sym_keyboard_return);
                mEnterKey.label = null;
                break;
        }
    }
